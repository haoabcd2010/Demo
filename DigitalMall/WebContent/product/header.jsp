...
<div class="header" >
   	<div class="top">
   		...
   		<s:if test="#session.user==null"><span>[<a href="/TestDemo/login/index.jsp">登录</a>|<a href="/TestDemo/register/index.jsp">注册</a>]</span></s:if>
   	...
   	<div class="logo">
   		<div >
   			<a href="/TestDemo/main/index.jsp">
   				<img  src="${pageContext.request.contextPath}/main/images/logo.png" alt="当当网" />
   			</a>
   		</div>
   		<h1>快 乐 购 , 轻 松 购 !</h1>
   	</div>
